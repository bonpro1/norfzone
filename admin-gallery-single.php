...
<head>
  ...
  <title>Single Image View ~ Admin dashboard</title>
   ...
   if ($connect == TRUE) {
     ...
     echo $name;
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="dahboard.php" class="active">Home</a></li>
            ...
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                ...
                include'connect.php';
                 if (isset($_GET['id'])) {
                   $id = $_GET['id'];
                   $sql = mysqli_query($conn,"SELECT * FROM photos WHERE ID = $id");
                   if ($sql == TRUE) {
                     while($fata = $sql->fetch_assoc())
                     {
                      $name = $fata['Name'];
                      $image = $fata['Image'];
                      echo"<img src='Photos/".$image."' alt='".$name."' >";
                     }
                   }
                 }
                ?>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              if (isset($_GET['id'])) {
                   $id = $_GET['id'];
              $sql0 = mysqli_query($conn,"SELECT * FROM photos WHERE ID = $id;");
              if ($sql0 == TRUE) {
                while($fata0 = $sql0->fetch_assoc()){
                  $name = $fata0['Name'];
                  $cap = $fata0['Caption'];
                  $img = $fata0['Image'];
                  $date = $fata0['Date'];
                ...
                <li><strong>Category</strong> <span>".$cap."</span></li>
                <li><strong>Uploaded date</strong> <span>".$date."</span></li>
                <li><a href='delete.php? id=$id' class='bg-danger btn-visit align-self-start'>Delete Image</a></li>
              </ul>";
              }
            }
              ?>
