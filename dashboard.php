...
<head>
  ...
  <title>Admin Dashboard ~ SOG Images</title>
      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <p>This your entirely collection you can drop some images if you want to.</p>
           ...
           while($fata = $sql->fetch_assoc()){
            ...
            <div class='gallery-item h-100'>
              ...
              <div class='gallery-links d-flex align-items-center justify-content-center'>
                ...
                <a href='admin-gallery-single.php? id=$id' class='details-link'><i class='bi bi-link-45deg'></i></a>
              </div>
            </div>
