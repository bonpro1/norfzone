...
<head>
  ...
  <title>Upload Failed ~ SOG Images</title>
      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h2>Testimonial Upload Failed</h2>
            <p>Something went wrong in uploading testimony!</p>

            <a class="cta-btn" href="admin-about.php">Try Again</a>
