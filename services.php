...
<head>
  ...
  <title>Services ~ SOG Images</title>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <p>We make graphic design including making logos, banners etc...</p>
            </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <p>We do almost kind of photography like wedding phography, potrait photography ect...</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Video production</a></h4>
              <p>We make video production including capturing video footages and edit them and many more...</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Audio production</a></h4>
              <p>We make audio production including recording, mixing etc...</p>
            </div>
          </div><!-- End Service Item -->
