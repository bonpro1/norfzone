...
<body>
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
    ...
    <div class="row justify-content-center mt-4">
          ...
          <div class="col-lg-9">
            <form action="upload-testimony.php" method="post"  class="php-email-form" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Testimonial Name" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="profession" id="email" placeholder="Testimonial Profession" required>
                </div>
              </div>
              <div class="col-md-12 form-group mt-3 mt-md-0">
                <textarea class="form-control" name="testimony" id="subject" placeholder="Testimony" required></textarea>
              </div>
              <div class="col-md-12 form-group mt-3 mt-md-0">
                <input type="text" class="form-control" name="rate" id="subject" placeholder="Testimonial Rate" required>
              </div>
